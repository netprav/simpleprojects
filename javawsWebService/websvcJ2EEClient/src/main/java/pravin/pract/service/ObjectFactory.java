 ...
 * generated in the pravin.pract.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorldResponse_QNAME = new QName("http://service.pract.pravin/", "helloWorldResponse");
    private final static QName _HelloWorld_QNAME = new QName("http://service.pract.pravin/", "helloWorld");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: pravin.pract.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.pract.pravin/", name = "helloWorldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.pract.pravin/", name = "helloWorld")
